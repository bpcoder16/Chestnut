...
func corsPreCheckRequest() gin.HandlerFunc {
	return func(ctx *gin.Context) {
		if ctx.Request.Method == http.MethodOptions {
			...
			// 允许的请求头
			ctx.Header("Access-Control-Allow-Headers", "Authorization, Content-Type, If-Match, If-Modified-Since, If-None-Match, If-Unmodified-Since, X-CSRF-TOKEN, X-Requested-With, Token, equipmentType, pseudoUniqueID, Ticket")
			// 预检请求的缓存时间
